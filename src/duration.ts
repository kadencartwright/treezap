export type DurationParseErrorReason = "expected_duration" | "must_be_positive_days"
...
export const isDurationParseError = (value: MinAgeDays): value is DurationParseError =>
  typeof value !== "number"
